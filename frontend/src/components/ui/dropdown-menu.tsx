...
function DropdownMenuCheckboxItem({
  ...
  const indicatorAlignmentClass =
    indicatorSide === "right" ? "right-2 left-auto" : "left-2"
  const paddingClass = indicatorSide === "right" ? "pr-8 pl-2" : "pr-2 pl-8"
